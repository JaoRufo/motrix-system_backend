...
router.post(
  ...
  [
    ...
    body("ordem.descricao_problema")
      .notEmpty()
      .withMessage("Descrição do problema é obrigatória"),
    body("ordem.data_prevista")
      .optional()
      .isDate()
      .withMessage("data_prevista deve ser uma data válida (YYYY-MM-DD)"),
    body("ordem.mecanico_id")
      .optional()
      .isInt()
      .withMessage("Mecânico ID deve ser um número"),
...
router.put(
  ...
  [
    ...
    body("ordem.km_atual")
      .optional()
      .isInt()
      .withMessage("KM atual deve ser um número"),
    body("ordem.data_prevista")
      .optional()
      .isDate()
      .withMessage("data_prevista deve ser uma data válida (YYYY-MM-DD)"),
    ...
    body("maoObra")
      .optional()
      .isArray()
      .withMessage("Mão de obra deve ser um array"),
  ],
